...
import { Target, TrendingUp, Users, BarChart3, ArrowLeft } from 'lucide-react';
        ...
        >
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <div style={{
              ...
              {[
                { icon: TrendingUp, label: 'Conversión', value: '12.4%', color: '#10B981' },
                { icon: Users, label: 'Leads', value: '2,847', color: '#2463EB' },
                { icon: BarChart3, label: 'ROI', value: '340%', color: '#F59E0B' }
              ].map((metric, index) => (
                <motion.div
                  key={metric.label}
                  initial={{ opacity: 0, y: 20 }}
